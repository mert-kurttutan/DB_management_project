...
class BufDesc {
 ...
 public:
  /**
   * @brief get pincount, needed for btree
   * 
   */
  auto getPinCount(){
	  return pinCnt;
...
class BufMgr 
{
 ...
 public:
  ...
  void clearBufStats() 
  {
	...
	/**
	 * 
	 * @return number of total frame in the buffer
	 */
  ...
  auto numBuf(){
	...
	/**
	 * @brief Get the Buf Desc Table object, needed for btree
	 * 
	 * @return buf desrcriğt table object
	 */

  auto getBufDescTable(){
	  return bufDescTable;
  }
};
